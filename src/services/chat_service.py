...
def parse_intent_and_execute(
    ...
    if extracted_filters["location"] or extracted_filters["amenities"] or extracted_filters["bhk"]:
        ...
        if raw_results:
            ...
            # -------------------------------------------------
            # Convert image_urls string -> Python list
            # -------------------------------------------------
            if "image_urls" in ranked_df.columns:
                ranked_df["image_urls"] = ranked_df["image_urls"].apply(
                    lambda x: (
                        ast.literal_eval(x)
            ...
            print("\n===== RANKED_DF COLUMNS =====")
            print(sorted(ranked_df.columns.tolist()))
            print("=============================\n")
