...
def run_mcp_advisor(property_ids: list[str]) -> pd.DataFrame:
    ...
    available_cols = [c for c in future_cols if c in enriched_df.columns]

    print("Available columns:", available_cols)

    if available_cols:
        print(enriched_df[available_cols].to_string(index=False))
    else:
        print("❌ None of the Future Growth columns exist!")
