...
def get_price_prediction(property_ids: list[str]) -> list[dict]:
    ...
    print("\n====================================")
    print("ENTERED property_tools.get_price_prediction")
    ...
    if not target_ids:
        print("❌ No valid property IDs received")
        return []

    try:
        print("🚀 CALLING run_mcp_prediction()")

        result_df = run_mcp_prediction(target_ids)

        print("✅ run_mcp_prediction() returned")
