...
def run_future_agent(df):
    ...
    for _, row in df.iterrows():
        ...
        # Combine text from "features_text" and "nearest_text" columns into one single text string for future growth analysis
        text = " ".join([
            str(row.get("features_mcp", "")),
            str(row.get("nearest_mcp", "")),
            str(row.get("transportation_hubs_clean", "")),
            str(row.get("amenities_mcp", ""))
        ])
        ...
        print("\n================ FUTURE DEBUG ================")
        print("ID:", row.get("id"))
        print("features_text:", row.get("features_text"))
        print("nearest_text:", row.get("nearest_text"))
        print("features_mcp:", row.get("features_mcp"))
        print("nearest_mcp:", row.get("nearest_mcp"))
