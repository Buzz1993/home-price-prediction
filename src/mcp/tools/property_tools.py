...
def _convert_image_urls(df: pd.DataFrame) -> pd.DataFrame:
    """
    Convert image_urls stored as string representations
...
def search_properties(bhk: str = None, amenities: str = None, location: str = None, limit: int = 5) -> list[dict]:
    ...
    results_df = _convert_image_urls(results_df)
...
def get_property_details(property_id: str) -> dict:
    ...
    match_frame = _convert_image_urls(match_frame)
