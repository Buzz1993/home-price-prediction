...
# ============================================================
# CUSTOM TRANSFORMERS FOR RECCOMENDATION SYSTEM
# ============================================================

class CategoryCleaner_rec(BaseEstimator, TransformerMixin):
    def __init__(self, cols=None):
        self.cols = cols
    ...
    def fit(self, X, y=None):
        if self.cols is None:
            self.cols = [c for c, dt in X.dtypes.items() if dt == "object"]
        self.feature_names_in_ = list(self.cols)
        return self
...
class FrequencyThresholdCategoriesTransformer_rec(BaseEstimator, TransformerMixin):
    def __init__(self, thresholds=None, default_threshold=20, other_label="__other__"):
        self.thresholds = thresholds or {}
        self.default_threshold = default_threshold
        self.other_label = other_label
    ...
    def fit(self, X, y=None):
        ...
        self.fitted_ = True   # ✅ ADD THIS
        return self

    def transform(self, X):
        check_is_fitted(self, "fitted_")   # ✅ ADD THIS
